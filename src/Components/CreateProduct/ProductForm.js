    ...
    return (
        <form className="row g-3" onSubmit={createProductEventHandler}>
            ...
            <div className="form-check form-switch">
                <input className="form-check-input" type="checkbox" role="switch" id="isAvailable" checkede={pAvailable} onChange={availabilityInputHandler}/>
